...
import { ClickCounter } from './patterns/ClickCounter';
import { ClickCounterHooks } from './patterns/ClickCounterHooks'
import { CounterReducer } from './patterns/CounterReducer';

import { RedditApp } from './redux/reddit/index'
import { Counter } from './redux/counter/components';
  ...
  <div>
    <nav>
      <ul>
        ...
        <li>
          <Link to="/click-counter-hooks">Click-counter hooks</Link>
        </li>
        <li>
    ...
    <Switch>
      ...
      <Route path="/click-counter-hooks">
        <ClickCounterHooks defaultCount={10} />
      </Route>
